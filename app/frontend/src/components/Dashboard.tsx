    ...
    <div className='dashboard-wrapper'>
      ...
      {scanResult && (
        <div className='scan-results'>
          ...
          <p><strong>Repository:</strong> {scanResult.repository}</p>
          <p><strong>Total Files Scanned:</strong> {scanResult.total_files_scanned}</p>
            ...
            <div className='key-detection-wrapper'>
              ...
              <ul>
                {scanResult.findings.map((finding, index) => (
                  <li key={index}>
                    <strong>{finding.key_type}</strong> key in <code>{finding.file_path}</code> at line {finding.line_number}:<br />
